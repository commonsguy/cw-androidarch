...
public class TripTests {
  ...
  public void notes() {
    ...
    final Comment comment=new Comment("um, hi!", trip);
    ...
    final Link link=new Link("Some page", "https://commonsware.com", trip);
  ...
  private boolean areCommentsIdentical(Comment one, Comment two) {
    return one.id.equals(two.id) &&
      one.tripId.equals(two.tripId) &&
      one.title.equals(two.title);
  }

  private boolean areLinksIdentical(Link one, Link two) {
    return one.id.equals(two.id) &&
      one.tripId.equals(two.tripId) &&
      one.title.equals(two.title) &&
      one.url.equals(two.url);
  }
}
