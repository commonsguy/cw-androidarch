...
public class RosterReport implements Report<List<ToDoModel>> {
  ...
  @Override
  public <D> Single<D> generate(List<ToDoModel> content,
                                ReportWriter<D> writer) {
    return(writer.write(template.execute(content)));
  }
}
